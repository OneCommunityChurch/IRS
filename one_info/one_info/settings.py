...
if PRODUCTION_SERVER:
    DATABASES = {
        'default': {
            ...
            'NAME': 'one_irs',                      # Or path to database file if using sqlite3.
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'one_info.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'u85oqwu-gc7!q%jo$wbt1du(@^x$*b=%z7!1@wsot5h09$d0_a'
...
ROOT_URLCONF = 'one_info.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'one_info.wsgi.application'
